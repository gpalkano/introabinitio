...
`````
## The potential
We will be using the N$^3$LO nucleon-nucleon potential whose circulated form can be found [here](https://github.com/gpalkano/introabinitio/blob/main/assets/codes/n3lo450.f90)
